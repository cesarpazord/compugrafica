...
void saveFrame(void) // guardamos las ftoso o fames
{
...
void resetElements(void) // reseteamos para tener nuevos datos 
{
...
void interpolation(void) // transición entre dos cuadros, cuadro que sigue - cuadro actual / numero de pasos
{
...
void KeyCallback(GLFWwindow *window, int key, int scancode, int action, int mode)
{
	...
	// A la cabeza con la tecla 4 y 5 rote y sea agregada a los keyframes 
}
void Animation() {
